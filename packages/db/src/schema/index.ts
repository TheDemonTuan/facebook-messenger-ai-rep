...
export const conversations = pgTable(
  "conversations",
  {
    ...
    humanHoldUntil: timestamp("human_hold_until", { withTimezone: true }),
    suppressedThroughInboundVersion: integer("suppressed_through_inbound_version").notNull().default(0),
    replyControlMode: varchar("reply_control_mode", { length: 32 }).notNull().default("AUTO"),
    controlEpoch: integer("control_epoch").notNull().default(0),
    controlReason: varchar("control_reason", { length: 64 }),
    ...
    observationCheckpoint: jsonb("observation_checkpoint").default({}),
