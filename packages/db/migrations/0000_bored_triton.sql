...
CREATE INDEX "ai_runs_conv_version_idx" ON "ai_runs" USING btree ("conversation_id","inbound_version");--> statement-breakpoint
...
CREATE INDEX "conversation_queue_claim_token_idx" ON "conversation_queue" USING btree ("claim_token");--> statement-breakpoint
...
CREATE INDEX "system_metrics_name_recorded_idx" ON "system_metrics" USING btree ("channel_account_id","metric_name","recorded_at");